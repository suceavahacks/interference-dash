    ...
    while running:
        ...
        if menu.in_menu:
            ...
            if not game_over and in_game:
                ...
                level_result = level.check_level_progression(score)
                if level_result == "game_won":
                    ...
                    pygame.draw.rect(screen, (255, 215, 0), (panel_x, panel_y, panel_width, panel_height), 5, 15)
                    
                    font_title = pygame.font.Font(None, 100)
                    font_subtitle = pygame.font.Font(None, 48)
                    
                    title_text = font_title.render("YOU WIN!", True, (255, 215, 0))
                    title_shadow = font_title.render("YOU WIN!", True, (127, 107, 0))
                    title_x = panel_x + panel_width // 2 - title_text.get_width() // 2
                    screen.blit(title_shadow, (title_x + 4, panel_y + 54))
                    screen.blit(title_text, (title_x, panel_y + 50))
                    
                    congrats = font_subtitle.render("CONGRATULATIONS!", True, (100, 255, 200))
                    congrats_x = panel_x + panel_width // 2 - congrats.get_width() // 2
                    screen.blit(congrats, (congrats_x, panel_y + 160))
                    
                    escaped = font_subtitle.render("You escaped the apocalypse!", True, (255, 200, 120))
                    escaped_x = panel_x + panel_width // 2 - escaped.get_width() // 2
                    screen.blit(escaped, (escaped_x, panel_y + 210))
